...
import org.sulong.project12306.services.shortlinkservice.common.enums.VailDateTypeEnum;
import org.sulong.project12306.services.shortlinkservice.config.GotoDomainWhiteListConfiguration;
...
import org.sulong.project12306.services.shortlinkservice.dto.resp.*;
import org.sulong.project12306.services.shortlinkservice.mq.producer.ShortLinkStatsSaveProducer;
import org.sulong.project12306.services.shortlinkservice.service.ShortLinkService;
import org.sulong.project12306.services.shortlinkservice.toolkit.HashUtil;
import org.sulong.project12306.services.shortlinkservice.toolkit.LinkUtil;
...
import static org.sulong.project12306.services.shortlinkservice.common.constant.RedisKeyConstant.*;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    private String generateSuffixByLock(ShortLinkCreateReqDTO requestParam) {
        ...
        while (true){
            ...
            String originalUrl=requestParam.getOriginUrl() + UUID.randomUUID();
            shortUri=HashUtil.hashToBase62(originalUrl);LambdaQueryWrapper<ShortLinkDO> queryWrapper = Wrappers.lambdaQuery(ShortLinkDO.class)
                    .eq(ShortLinkDO::getGid, requestParam.getGid())
